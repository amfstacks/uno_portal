<div class="space-y-4">
    <div>
        ...
        <input type="text" name="<?= $page === 'courses' ? 'title' : 'name' ?>" 
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div>
            ...
            <input type="number" name="units" value="{{units}}" min="1" max="6" class="w-full px-4 py-2 border rounded-lg">
        </div>
    </div>
    <div class="grid grid-cols-2 gap-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Session</label>
            <input type="text" name="session" value="{{session}}" placeholder="2025/2026" class="w-full px-4 py-2 border rounded-lg">
        </div>
        <div>
